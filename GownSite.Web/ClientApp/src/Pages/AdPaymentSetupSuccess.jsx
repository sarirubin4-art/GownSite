...
const AdPaymentSetupSuccess = () => {
    ...
    useEffect(() => {
        const confirm = async () => {
            ...
            try {
                await axios.post('/api/payment/confirm-ad-setup-session', { sessionId });
                setConfirmed(true);
            } catch (err) {
        ...
        <Container maxWidth="xs" sx={{ py: 8, textAlign: 'center' }}>
            <Paper variant="outlined" sx={{ p: 4 }}>
                {error ? (
                    ...
                    <>
                        <Typography variant="h5" gutterBottom>Your ad is under review!</Typography>
...
export default AdPaymentSetupSuccess;
